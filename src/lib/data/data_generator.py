...
_ADA_SEG_INFORMATION = DatasetDescriptor(
	splits_to_sizes={
		'train': 800, #number of images for training
		'trainval': 1000, #total number of image
		'val': 200, #number of images for validation
	},
